...
// set anchor point from link to node
...
// draw link considering straight or curved path
...
// set initial mouse for movement 
...
// set the initial mouse angel for self-loop movement 
...
// restore graph state from local backup
...
// save the currnt state in local storage 
function saveBackup() {
	if(!localStorage || !JSON) {
		return;
	}
...
// heelps to determine x,y cordinates of selected node 
...
// adijust position of node by nearby padding 
...
//initializes canvas, restore the backup
window.onload = function() {
	canvas = document.getElementById('canvas');
	restoreBackup();
	draw();
// assist in mouse down event 
...
var shift = false;
// reset the shift variable when shift is realesed
...
// used for different browser differences in key,mouse events 
...
// outputs text to an element with ID output
